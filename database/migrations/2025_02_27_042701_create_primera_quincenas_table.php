...
return new class extends Migration
{
    ...
    {
        Schema::create('primera_quincenas', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('fetratrujillo', total: 8, places: 2)->nullable();
            $table->decimal('fetrasalud', total: 8, places: 2)->nullable();
            $table->decimal('sindicato_de_salud', total: 8, places: 2)->nullable();
    ...
    {
        Schema::dropIfExists('primera_quincenas');
    }
};
