                                ...
                                <div class="text-center mb-4">
                                    ...
                                    <h4 class="text-center">TALENTO HUMANO</h4>
                                        ...
                                        <div class="alert alert-dismissible alert-info" bis_skin_checked="1">
                                            <p class="text-justify">La constancia de Trabajo <strong>{{$trabajadorCedula->nombre}}</strong> para el Mes de <strong>{{$mesrecibo}}</strong> del Año <strong>{{$primeraQuincena->ano}}</strong> es legítima. <i class="fa fa-check"></i></p>
