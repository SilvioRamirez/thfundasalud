...
<head>
    ...
    <title>Restablecer Contraseña - FUNDASALUD Trujillo</title>
        ...
        <div class="login-left">
            <div class="login-left-content">
                ...
                <div class="mt-4">
                    ...
                    <span class="feature-badge"><i class="fa fa-key"></i> Protegido</span>
                    <span class="feature-badge"><i class="fa fa-check"></i> Verificado</span>
                </div>
            </div>
        </div>
            ...
            <div class="login-form-container">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <button type="submit" class="btn-login">
                        <i class="fa fa-check-circle"></i> Restablecer Contraseña
                    </button>
