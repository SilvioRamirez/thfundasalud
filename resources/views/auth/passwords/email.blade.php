...
<head>
    ...
    <title>Recuperar Contraseña - FUNDASALUD Trujillo</title>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            <div class="login-left-content">
                ...
                <p>Te ayudaremos a recuperar el acceso a tu cuenta de forma segura</p>
                <div class="mt-4">
                    <span class="feature-badge"><i class="fa fa-shield-alt"></i> Seguro</span>
                    <span class="feature-badge"><i class="fa fa-lock"></i> Confidencial</span>
                    <span class="feature-badge"><i class="fa fa-clock"></i> Rápido</span>
                </div>
            </div>
        </div>
