...
class SegundaQuincenaDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                    ...
                    if(auth()->user()->can('edit-segundaquincena')){
                        $buttons .= '<a class="btn btn-primary btn-sm" title="Editar Información" href="'.route('segundaquincena.edit',$query->id).'"> <i class="fa fa-pen-to-square"></i></a>';
                    }
     ...
     */
    public function query(SegundaQuincena $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('segundaquincena-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('bono_nocturno_por_guardia')->title('BONO NOCTURNO POR GUARDIA'),
            Column::make('bono_nocturno_fijo')->title('BONO NOCTURNO FIJO'),
            Column::make('domingo_y_feriados_por_guardia')->title('DOMINGO Y FERIADOS POR GUARDIA'),
            Column::make('bono_vacacional')->title('BONO VACACIONAL'),
            Column::make('prima_por_hijos')->title('PRIMA POR HIJOS'),
    ...
    {
        return 'SegundaQuincena_' . date('YmdHis');
    }
}
