...
class PrimeraQuincenaImport implements ToModel, WithHeadingRow, WithChunkReading, WithBatchInserts, WithCustomCsvSettings
{
    ...
    */
    public function model(array $row)
    {
        return new PrimeraQuincena([
            ...
            'fetratrujillo' => $row['fetratrujillo'] ?? null,
            'fetrasalud' => $row['fetrasalud'] ?? null,
            'sindicato_de_salud' => $row['sindicato_de_salud'] ?? null,
